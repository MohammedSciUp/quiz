...
from .views import lesson_detail, lessons_list, login_view, teacher_dashboard_view, view_students_progress, list_submissions_view, mark_quiz_view, make_quiz_view, teacher_dashboard_view, view_quizzes_view, take_quiz_view, student_dashboard_view
