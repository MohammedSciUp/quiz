...
from .models import (
    ...
    MultipleChoiceAnswer, ShortEssayAnswer, QuizSubmission, Marks, UserProfile
)
from .forms import (
...
def make_quiz_view(request):
    ...
    # Formsets for multiple choice and essay questions
    ...
    if request.method == 'POST':
        ...
        if quiz_form.is_valid() and mcq_formset.is_valid() and essay_formset.is_valid():
            ...
            for mcq_form in mcq_formset:
                if mcq_form.cleaned_data:  # Make sure form has data
            ...
            for essay_form in essay_formset:
                if essay_form.cleaned_data:  # Make sure form has data
    ...
    # Render the makequiz template with the formsets
